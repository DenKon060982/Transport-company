...
import by.konovalchik.company.dao.ComparatorTransportPrice;
import by.konovalchik.company.dao.ComparatorTransportSpeed;
...
public class SearchTransportsAction implements Action  {
    private CompanyController controller = new CompanyControllerImp();
    ...
    public void apply(){
        ...
        do {
            ...
            city2 = controller.searchCity(city1);
        ...
        do {
            ...
            city4 = controller.searchCity(city3);
        ...
        List<Transport> transports = controller.searchTransport(airport,seaport, capacity, carrying);
